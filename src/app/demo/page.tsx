...
export const metadata: Metadata = {
  ...
  description:
    "Retail + agent 402 simulations (no wallet). Platform sims (API credits, terminal, webhooks) live under /demo/developer.",
};
  ...
  return (
    <div className="space-y-4 pb-6">
      <DocHero
        ...
        description={
          <>
            Simulations run entirely in the browser (no wallet, no RPC). For the live flow,{" "}
            ...
            . More scenarios:{" "}
            <Link href="/demo/developer" className="font-medium text-teal hover:underline">
              Platform sim
            </Link>
            .
          </>
      ...
      <p className="text-center text-[11px] text-faint">
        ...
        {" · "}
        <Link href="/demo/developer" className="text-teal underline-offset-2 hover:underline">
          Platform sim
        </Link>
        .
      </p>
